 ...
 * desenfoque leve. Entran TODOS a la vez (stagger 0): el gesto es uno solo,
 * suave y largo, no una fila de apariciones una atrás de otra.
 *
 ...
 * `stagger` sigue disponible para quien quiera escalonar a propósito.
 */
